...
<div id='main'>
    <form action="candidature" method="post" enctype="multipart/form-data">
        ...
        <input type="file" name="mp3" multiple accept=".mp3" required="required" value='{$data.fmp3|escape|default:''}'><br>
        <input type="file" name="mp3" multiple accept=".mp3" required="required" value='{$data.smp3|escape|default:''}'><br>
        <input type="file" name="mp3" multiple accept=".mp3" required="required" value='{$data.tmp3|escape|default:''}'><br>
        ...
        <input type="file" name="photo" multiple accept=".jpg, .jpeg, .png" required="required" value='{$data.fphoto|escape|default:''}'><br>
        <input type="file" name="photo" multiple accept=".jpg, .jpeg, .png" required="required" value='{$data.sphoto|escape|default:''}'><br>
